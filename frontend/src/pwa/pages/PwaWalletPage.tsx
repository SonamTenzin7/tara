  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        height: 40,
        borderRadius: 12,
        background: isCredit ? "rgba(34, 197, 94, 0.1)" : "rgba(59, 130, 246, 0.1)",
...
export function PwaWalletPage() {
  ...
  return (
    <div style={{ padding: "32px 16px 100px", maxWidth: 600, margin: "0 auto", position: "relative" }}>
      ...
      {loading && (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "100px 0", gap: 16 }}>
          ...
          <span style={{ color: "var(--text-subtle)", fontWeight: 600 }}>Syncing balance...</span>
        </div>
      )}
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ fontSize: "0.85rem", fontWeight: 700, color: "rgba(255,255,255,0.8)", marginBottom: 8 }}>Available Balance</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 24 }}>
                <span style={{ fontSize: "2.4rem", fontWeight: 900, color: "#fff" }}>
                  {Number(profile.creditsBalance).toLocaleString()}
                </span>
                <span style={{ fontSize: "1rem", fontWeight: 800, color: "rgba(255,255,255,0.6)" }}>BTN</span>
              </div>
              
              <div style={{ display: "flex", gap: 24 }}>
                <div>
                  <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "rgba(255,255,255,0.6)", textTransform: "uppercase" }}>Total In</div>
                  <div style={{ fontSize: "1rem", fontWeight: 800, color: "#fff" }}>+{totalIn.toLocaleString()}</div>
                </div>
                <div>
                  <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "rgba(255,255,255,0.6)", textTransform: "uppercase" }}>Total Out</div>
                  <div style={{ fontSize: "1rem", fontWeight: 800, color: "#fff" }}>{Math.abs(totalOut).toLocaleString()}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 32 }}>
            <button style={{ 
              ...
              padding: "16px", borderRadius: 16, background: "var(--deposit-btn-bg)",
            ...
            <button style={{ 
              display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
              padding: "16px", borderRadius: 16, background: "var(--bg-card)",
          ...
          <div style={{ padding: "0 4px" }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              <div>
                <h2 style={{ fontSize: 18, fontWeight: 900, color: "var(--text-main)", margin: 0, fontFamily: "var(--font-display)" }}>History</h2>
                <div style={{ fontSize: 12, fontWeight: 600, color: "var(--text-subtle)", marginTop: 2 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              {txs.length === 0 ? (
                <div style={{ textAlign: "center", padding: "48px 0", color: "var(--text-subtle)" }}>
                  <Wallet size={48} strokeWidth={1.5} style={{ marginBottom: 12, opacity: 0.5 }} />
